...
<link rel="stylesheet" href="style2.css">
  <body>
  <img src="acLogo.png" alt="LOGO" class="logo_index">
      <div class="login_con">
<?php
...
?>
    ...
    <div class="container-fluid" >
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical" style="background-color:#FFFFFF;">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true" style="color:#000000;"><b>Item</b></a>
			  <a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false" style="color:#000000;"><b>Purchase</b></a>
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false" style="color:#000000;"><b>Seller</b></a>
			  <a class="nav-link" id="v-pills-sale-tab" data-toggle="pill" href="#v-pills-sale" role="tab" aria-controls="v-pills-sale" aria-selected="false" style="color:#000000;"><b>Sale</b></a>
			  <a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false" style="color:#000000;"><b>Customer</b></a>
			  <a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false" style="color:#000000;"><b>Reports</b></a>
			</div>
		</div>
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
					...
					<div class="tab-content">
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <button type="button" id="updateItemDetailsButton" class="btn btn-success">Update</button>
							  <button type="button" id="deleteItem" class="btn btn-danger">Delete</button>
							  <button type="reset" class="btn btn-warning" id="itemClear">Clear</button>
							</form>
						</div>
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <div class="form-row"> 
						  ...
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsVendorName">Suppl Name<span class="requiredIcon">*</span></label>
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						 ...
						 <div class="form-group col-md-3">
							<label for="vendorDetailsVendorID">Seller ID</label>
					  ...
					  <button type="button" id="addVendor" name="addVendor" class="btn btn-success">Add Seller</button>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Search Inventory<button id="searchTablesRefresh" name="searchTablesRefresh" class="btn btn-success float-right btn-sm">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#vendorSearchTab">Seller</a>
						</li>
					</ul>
					...
					<div class="tab-content">
						...
						<div id="vendorSearchTab" class="container-fluid tab-pane fade">
							<br>
							<p>Use the grid below to search Seller details</p>
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Reports<button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-success float-right btn-sm">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#vendorReportsTab">Seller</a>
						</li>
					</ul>
